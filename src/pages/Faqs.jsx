    ...
    <div className="bg-black text-white pt-[90px]">
      ...
      <section className="relative h-[320px] w-full">
        ...
        <div className="absolute inset-0 flex items-center justify-center md:justify-start">
          <div className="bg-red-700/90 px-6 md:px-8 py-4 md:py-4 md:ml-10 rounded">
          ...
          <div className="border border-gray-800">
            ...
            {admissionsDropdownItems.map((item, index) => (
              <Link
                key={index}
                to={item.path}
                className={`block px-6 py-4 border-b border-gray-800 transition ${item.name === "Frequently Asked Questions"
